...
public class TeamCheck{
	...
	public static void main(String[] args){
		...
		do{
			...
			}catch(Exception e3){ //Gesti�n del error lanzado por el constructor de la clase Team que usa los diferentes setters setShortName, setMembers, setBudget y setFounded, los cuales pueden lanzar una excepci�n (Ejercicio 2)
